...
export default function DataCollectionPlanPage() {
  const dataCollectionSteps = [
    ...
    { title: "Availability of secondary data", icon: <DatabaseZap className="h-8 w-8 text-indigo-500" />, href: "/monitoring/data-collection/secondary-data" },
    { title: "Determine the quantitative and qualitative data", icon: <Binary className="h-8 w-8 text-purple-500" />, href: "/monitoring/data-collection/data-types" },
    { title: "Determine sampling requirements", icon: <Percent className="h-8 w-8 text-sky-500" />, href: "/monitoring/sampling-calculator" },
    { title: "Prepare for any surveys", icon: <FileQuestion className="h-8 w-8 text-green-500" />, href: "/monitoring/data-collection/surveys" },
    { title: "Establish Monitoring staff selection Crietria", icon: <UserCheck className="h-8 w-8 text-red-500" />, href: "/monitoring/data-collection/staff-criteria" },
