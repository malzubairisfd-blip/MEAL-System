...
const DB_COLUMNS_FOR_CREATION = `(
    ...
    project_id TEXT, project_name TEXT, PROJ_NO TEXT, BATCH_NO TEXT, GOV_NO TEXT, MUD_NO TEXT, OZLA_NO TEXT, VILL_NO TEXT, MUD_LOC_ID TEXT, GOV_NAME TEXT,
    MUD_NAME TEXT, OZLA_NAME TEXT, VILL_NAME TEXT, ED_NO TEXT, ED_ID TEXT, EC_ID TEXT, PC_ID TEXT, ED_NAME TEXT, EC_NAME TEXT, PC_NAME TEXT,
    SRVY_HH_ID TEXT, CANDID_SER_NO TEXT, WOMAN_ID TEXT, ID TEXT, BENEF_ID TEXT, BENEF_NO TEXT, HH_NAME TEXT, BNF_RELATION TEXT, BENEF_NAME TEXT,
    HUSBAND_NAME TEXT, CHILD_LIST_STR TEXT, CHILD_LIST_LONG TEXT, BNF_SOCIAL_STATUS TEXT, SOCIAL_STATUS_DESC TEXT, IS_ACTIVE TEXT,
    STATUS TEXT, QUAL_STATUS TEXT, STATUS_DESC TEXT, QUAL_STATUS_DESC TEXT, VERIFY_STATUS TEXT, VERIFY_NOTES TEXT, VERIFY_REASON TEXT,
    VERIFY_DATE TEXT, REG_STATUS TEXT, REG_FORM_DATE TEXT, REG_NOTES TEXT, TOTAL_CHILD_COUNT TEXT, MALE_CHILD_COUNT TEXT,
    FEMALE_CHILD_COUNT TEXT, LOC_ID TEXT, LOC_NAME TEXT, ID_CARD_TYPE TEXT, ID_CARD_TYPE_DESC TEXT, ID_CARD_NO TEXT, AGE_YEARS TEXT,
    ADDRESS TEXT, PHONE_NO TEXT, IS_TERMINATED TEXT, TERM_DATE TEXT, TERM_REASON TEXT, TERM_NOTES TEXT, NOTES TEXT, PC_FAC_ID TEXT, EC_FAC_ID TEXT,
    BENEF_CLASS TEXT, BENEF_CLASS_DESC TEXT, OLD_BNF_NAME TEXT, OLD_HSBND_NAME TEXT, OLD_PHONE_NO TEXT, OLD_ID_CARD_NO TEXT,
    ed_phone TEXT, new_ed_id TEXT, new_ed_name TEXT, new_ed_phone TEXT, new_ec_id TEXT, new_ec_name TEXT, new_pc_id TEXT, new_pc_name TEXT,
