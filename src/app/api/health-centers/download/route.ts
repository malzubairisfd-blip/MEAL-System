// src/app/api/health-centers/download/route.ts
import { NextResponse } from "next/server";
import fs from "fs/promises";
import path from "path";

const getDbPath = () => path.join(process.cwd(), 'src/data', 'health-center.db');
    ...
    try {
        ...
        return new NextResponse(fileBuffer, {
            headers: {
                ...
                'Content-Disposition': 'attachment; filename="health-center.db"',
            },
        });
    } catch (error: any) {
