...
function initializeDatabase(recreate: boolean = false) {
    ...
    comments TEXT,
    diff_per__bnf1 INTEGER, 
    diff_per__bnf2 INTEGER, 
    diff_per__bnf3 INTEGER, 
    diff_per__bnf4 INTEGER, 
    diff_per__bnf5 INTEGER, 
    diff_per__bnf INTEGER, 
    diff_per__hus1 INTEGER, 
    diff_per__hus2 INTEGER,
    diff_per__hus3 INTEGER,
    diff_per__hus4 INTEGER,
    diff_per__hus5 INTEGER,
    diff_per__hus INTEGER,
    internalId TEXT,
    data JSON
);
    `;
...
export async function POST(req: Request) {
    ...
    try {
        ...
        // Filter out 'id' from the columns to insert, as it's autoincremented
