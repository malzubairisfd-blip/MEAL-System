// src/app/meal-system/monitoring/implementation/process/CMAM-cases/beneficiaries/referral/page.tsx
"use client";

import Link from "next/link";
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { ArrowLeft, ArrowRight, FileDown, FileEdit } from "lucide-react";
...
export default function ReferralHubPage() {
  ...
  const features = [
    {
      labelKey: "hubs.beneficiariesCmamReferral.export",
      descriptionKey: "hubs.beneficiariesCmamReferral.exportDesc",
    ...
    {
      labelKey: "hubs.beneficiariesCmamReferral.entry",
      descriptionKey: "hubs.beneficiariesCmamReferral.entryDesc",
  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">{t('hubs.beneficiariesCmamReferral.title')}</h1>
        <Button variant="outline" asChild>
          <Link href="/meal-system/monitoring/implementation/process/CMAM-cases/beneficiaries">
            <ArrowLeft className="mr-2 h-4 w-4" />
            {t('hubs.beneficiariesCmamReferral.back')}
          </Link>
        </Button>
      </div>
