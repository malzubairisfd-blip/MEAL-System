// src/app/meal-system/monitoring/implementation/process/CMAM-cases/beneficiaries/confirmation/page.tsx
"use client";
...
export default function ConfirmationHubPage() {
  ...
  const features = [
    {
      labelKey: "hubs.beneficiariesCmamConfirmation.export",
      descriptionKey: "hubs.beneficiariesCmamConfirmation.exportDesc",
      href: "/meal-system/monitoring/implementation/process/CMAM-cases/beneficiaries/confirmation/export",
      icon: <FileText className="h-8 w-8 text-blue-500" />,
    },
    {
      labelKey: "hubs.beneficiariesCmamConfirmation.entry",
      descriptionKey: "hubs.beneficiariesCmamConfirmation.entryDesc",
      href: "/meal-system/monitoring/implementation/process/CMAM-cases/beneficiaries/confirmation/entry",
  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">{t('hubs.beneficiariesCmamConfirmation.title')}</h1>
        <Button variant="outline" asChild>
          <Link href="/meal-system/monitoring/implementation/process/CMAM-cases/beneficiaries">
            <ArrowLeft className="mr-2 h-4 w-4" />
            {t('hubs.beneficiariesCmamConfirmation.back')}
          </Link>
        </Button>
      </div>
