...
export default function BeneficiaryCMAMPage() {
  ...
  const features = [
    {
      labelKey: "hubs.beneficiariesCmam.screening",
      descriptionKey: "hubs.beneficiariesCmam.screeningDesc",
    ...
    {
      labelKey: "hubs.beneficiariesCmam.confirmation",
      descriptionKey: "hubs.beneficiariesCmam.confirmationDesc",
    ...
    {
      labelKey: "hubs.beneficiariesCmam.referral",
      descriptionKey: "hubs.beneficiariesCmam.referralDesc",
  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">{t('hubs.beneficiariesCmam.title')}</h1>
        <Button variant="outline" asChild>
          <Link href="/meal-system/monitoring/implementation/process/CMAM-cases">
            <ArrowLeft className="mr-2 h-4 w-4" />
            {t('hubs.beneficiariesCmam.back')}
          </Link>
        </Button>
      </div>
