// src/app/meal-system/monitoring/implementation/process/CMAM-cases/beneficiaries/confirmation/export/page.tsx
...
export default function ExportCmamStatementsPage() {
    ...
    const handleDownload = async (isSample = false) => {
        ...
        try {
            const res = await fetch(`/api/bnf-cmam?projectId=${selectedProjectId}`);
            ...
            const worker = new Worker(new URL('@/workers/confirmationbnfcmam-export.worker.ts', import.meta.url));
