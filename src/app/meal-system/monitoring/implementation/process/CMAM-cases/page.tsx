...
export default function CMAMCasesPage() {
  ...
  const features = [
    {
      labelKey: "hubs.cmamCases.beneficiaries",
      descriptionKey: "hubs.cmamCases.beneficiariesDesc",
      href: "/meal-system/monitoring/implementation/process/CMAM-cases/beneficiaries",
      icon: <Users className="h-8 w-8 text-blue-500" />,
    },
    {
      labelKey: "hubs.cmamCases.children",
      descriptionKey: "hubs.cmamCases.childrenDesc",
      href: "/meal-system/monitoring/implementation/process/CMAM-cases/children",
      icon: <HeartPulse className="h-8 w-8 text-green-500" />,
    },
    {
      labelKey: "hubs.cmamCases.healthWorker",
      descriptionKey: "hubs.cmamCases.healthWorkerDesc",
  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">{t('hubs.cmamCases.title')}</h1>
        <Button variant="outline" asChild>
          <Link href="/meal-system/monitoring/implementation/process">
            <ArrowLeft className="mr-2 h-4 w-4" />
            {t('hubs.cmamCases.back')}
          </Link>
        </Button>
      </div>
