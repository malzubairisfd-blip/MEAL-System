...
export default function ChildrenCMAMPage() {
  ...
  const features = [
    {
      labelKey: "hubs.childrenCmam.screening",
      descriptionKey: "hubs.childrenCmam.screeningDesc",
    ...
    {
      labelKey: "hubs.childrenCmam.confirmation",
      descriptionKey: "hubs.childrenCmam.confirmationDesc",
    ...
    {
      labelKey: "hubs.childrenCmam.referral",
      descriptionKey: "hubs.childrenCmam.referralDesc",
  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">{t('hubs.childrenCmam.title')}</h1>
        <Button variant="outline" asChild>
          <Link href="/meal-system/monitoring/implementation/process/CMAM-cases">
            <ArrowLeft className="mr-2 h-4 w-4" />
            {t('hubs.childrenCmam.back')}
          </Link>
        </Button>
      </div>
