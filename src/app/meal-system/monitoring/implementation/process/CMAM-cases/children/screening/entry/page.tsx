                          ...
                          {childrenOfBeneficiary.length > 0 ? childrenOfBeneficiary.map(c => (
                            ...
                            <TableRow>
                              <TableCell colSpan={3} className="text-center text-yellow-600 h-24 bg-yellow-500/10">
                                لايوجد طفل لدى المستفيدة مؤهل قد يكون عمر الطفل ٥ سنوات او اكثر يرجى اختيار مستفيدة أخرى او إدخال طفل جديد
                              </TableCell>
                            </TableRow>
                          )}
                        </TableBody>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 border rounded-lg bg-card">
                    ...
                    <FormField control={form.control} name="child_first_name" render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input placeholder="الاسم الأول فقط..." {...field} /></FormControl>
                      </FormItem>
                    )} />
                    ...
                    <FormField control={form.control} name="new_child_age_mon" render={({ field }) => (
                      <FormItem>
                        <FormLabel>عمر الطفل بالاشهر</FormLabel>
                        <FormControl><Input type="number" min="6" max="59" placeholder="6 - 59" {...field} /></FormControl>
                      </FormItem>
                    )} />
                  </div>
                )}
                  ...
                  <div className="space-y-6 pt-6 border-t border-dashed">
                    ...
                    {watchHasCmam === 'لا' && (
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-card p-6 rounded-lg border shadow-sm">
                        <FormField control={form.control} name="muac" render={({ field }) => (
                          <FormItem>
                            <FormLabel>قياس المواك: {field.value || 12.5}</FormLabel>
                            <FormControl>
                        ...
                        <FormField control={form.control} name="comments" render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl><Textarea placeholder="أدخل ملاحظاتك هنا..." {...field} /></FormControl>
                            <FormMessage />
                          </FormItem>
                        )} />
                      </div>
                    ...
                    {watchHasCmam === 'نعم' && (
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-card p-6 rounded-lg border shadow-sm">
                        ...
                        <FormField control={form.control} name="muac" render={({ field }) => (
                          <FormItem>
                            <FormLabel>قياس المواك: {field.value || 7}</FormLabel>
                            <FormControl>
                        ...
                        <FormField control={form.control} name="go_health_center" render={({ field }) => (
                          <FormItem>
                            <FormLabel>هل يذهب الى المرفق الصحي؟</FormLabel>
                            <FormControl>
                              <RadioGroup onValueChange={field.onChange} value={field.value} className="flex gap-6 pt-2">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            <FormField control={form.control} name="disc_date_day" render={({ field }) => (
                              <FormItem>
                            ...
                            <FormField control={form.control} name="disc_date_month" render={({ field }) => (
                              <FormItem>
                                <Select onValueChange={field.onChange} value={field.value}>
                            ...
                            <FormField control={form.control} name="disc_date_year" render={({ field }) => (
                              <FormItem>
                                <Select onValueChange={field.onChange} value={field.value}>
