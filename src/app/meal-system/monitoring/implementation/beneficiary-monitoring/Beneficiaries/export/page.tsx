                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div>
                         ...
                         <div className="flex flex-wrap gap-2">
                            ...
                            <Button variant="outline" asChild><Link href="/meal-system/monitoring/implementation/beneficiary-monitoring/Beneficiaries/report"><BarChartHorizontal className={language === 'ar' ? 'ml-2' : 'mr-2'}/>{t('sidebar.report')}</Link></Button>
                        </div>
                    </div>
                </CardHeader>
