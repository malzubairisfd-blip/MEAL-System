...
export default function CommunityEducatorsPage() {
  const features = [
    { title: "Community Educators Selection", href: "/meal-system/monitoring/implementation/beneficiary-monitoring/community-educators/selection", icon: <UserSearch className="h-8 w-8 text-blue-500" /> },
    { title: "Community Educators Interview", href: "/meal-system/monitoring/implementation/beneficiary-monitoring/community-educators/interview", icon: <MessageSquare className="h-8 w-8 text-teal-500" /> },
  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">Community Educators Management</h1>
