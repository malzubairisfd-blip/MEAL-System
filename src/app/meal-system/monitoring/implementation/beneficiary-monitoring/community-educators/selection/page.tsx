...
import { Loader2, Upload, Users, UserCheck, UserX, Save, FileDown, GitCompareArrows, Database, ClipboardList, ArrowLeft } from 'lucide-react';
            ...
            <div className="flex justify-between items-center">
              ...
              <Button variant="outline" asChild>
                  <Link href="/meal-system/monitoring/implementation/beneficiary-monitoring/community-educators">
                      <ArrowLeft className="mr-2 h-4 w-4" /> Back to Community Educators
                  </Link>
              </Button>
            </div>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="flex flex-wrap gap-2">
                            <Button asChild>
                                <Link href="/meal-system/monitoring/implementation/beneficiary-monitoring/community-educators/database">
                                    <Database className="mr-2 h-4 w-4" />
                                    Go to Educator Database
                                </Link>
                            </Button>
                             <Button asChild>
                                <Link href="/meal-system/monitoring/implementation/beneficiary-monitoring/community-educators/selection/review">
                                    <ClipboardList className="mr-2 h-4 w-4" />
                                    Go to Review Page
                                </Link>
                            </Button>
                            <Button asChild variant="outline">
                                <Link href="/meal-system/monitoring/implementation/beneficiary-monitoring/community-educators/training">
                                    <ClipboardList className="mr-2 h-4 w-4" />
                                    Go to Training Page
                                </Link>
                            </Button>
