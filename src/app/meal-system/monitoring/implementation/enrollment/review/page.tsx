  ...
  const features = [
    {
      ...
      description: "Upload new enrollment data, run analysis, and save to the database.",
      href: "/meal-system/monitoring/implementation/enrollment/review/upload",
      icon: <Upload className="h-8 w-8 text-blue-500" />,
    },
    {
      title: "Recommendation Page",
      description: "Review system-generated recommendations based on analysis.",
      href: "/meal-system/monitoring/implementation/enrollment/review/recommendation",
      icon: <ThumbsUp className="h-8 w-8 text-green-500" />,
    },
    {
      title: "Dashboard Page",
      description: "Visualize enrollment review data and KPIs.",
      href: "/meal-system/monitoring/implementation/enrollment/review/dashboard",
  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold">Enrollment Review Center</h1>
