...
function AddIndicatorPlanForm() {
    ...
    const onSubmit = async (data: IndicatorTrackingPlan) => {
        ...
        try {
            ...
            router.push('/meal-system/monitoring/initiation-and-planning/prepare-indicators');
        } catch(e: any) {
            ...
            <div className="flex justify-between items-center">
                <div>
                 ...
                 <Button variant="outline" asChild>
                    <Link href="/meal-system/monitoring/initiation-and-planning/prepare-indicators">
