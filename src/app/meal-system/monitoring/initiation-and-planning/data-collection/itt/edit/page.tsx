...
function EditITTForm() {
    ...
    const onSubmit = async (data: IndicatorTrackingPlan) => {
        ...
        try {
            ...
            router.push(`/meal-system/monitoring/initiation-and-planning/data-collection/itt?projectId=${selectedProjectId}`);
        } catch (e: any) {
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                ...
                <Button variant="outline" asChild>
                    <Link href={`/meal-system/monitoring/initiation-and-planning/data-collection/itt?projectId=${selectedProjectId || ''}`}>
