            ...
            <div className="flex justify-between items-center">
                 ...
                 <div className='flex gap-2'>
                    ...
                    <Button asChild disabled={!hasProjects} title={!hasProjects ? "Please create a project first" : ""}>
                        <Link href="/meal-system/project/logframe/add">
                            ...
                            {selectedLogframe && (
                                <div className="flex gap-2">
                                    <Button asChild variant="outline">
                                        <Link href={`/meal-system/project/logframe/edit?projectId=${selectedProject}`}>
                    ...
                    <CardContent>
                        {loading ? (
                            ...
                            <div className="text-center text-muted-foreground py-10">
                                ...
                                <Button variant="link" asChild><Link href="/meal-system/project/logframe/add">Create one now</Link></Button>
                            </div>
                        )}
                    </CardContent>
                </Card>
