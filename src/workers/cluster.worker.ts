...
import { preprocessRow, type PreprocessedRow, type WorkerOptions as PreprocessWorkerOptions, normalizeArabicWithCompounds } from './preprocess';
...
export type WorkerOptions = PreprocessWorkerOptions;
