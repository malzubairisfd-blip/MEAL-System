...
// This is a CLIENT-SIDE mirror of the scoring logic from the web worker.
// It is used for live testing on the settings page.
// ANY CHANGES HERE MUST BE REFLECTED IN THE WORKER.
...
export const computePairScore = (rawA: any, rawB: any, opts: ScoringOptions) => {
    const o = {
        ...defaultOptions,
        ...opts,
